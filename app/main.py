...
>>>>>>> 340140fd108f61d4a2e9627093cdf51a7331ccc7
...
#     <summary>Byttet tilfluktsrom-kilde fra lokal JSON-fil til Geonorge Nedlasting API.</summary>
#     <details>
#       <item>La til robust order/download-flyt med polling av bestilling.</item>
#       <item>La til cache for API-data og nytt endepunkt /api/shelters.</item>
#       <item>Oppdaterte nearest-oppslag for type=shelter til kun API-basert innlasting.</item>
#     </details>
#   </change>
# </changeLog>
